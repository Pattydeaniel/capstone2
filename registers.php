...
<body>
    <div class="form-container">
        ...
        <form action="save_register.php" method="POST" enctype="multipart/form-data">
            ...
            <label>Email: (Use your registered email)</label>
            ...
            <label>Lot: (Use your registered Lot)</label>
            <input type="number" name="lot" min="1" max="50" required>
        
            <label>Block: (Use your registered Block)</label>
            <select name="block">
            ...
            <select name="household_income" required>
                <option value="10,000">₱10,000 Below (Monthly Income)</option>
                <option value="11,000-25,000">₱11,000 - ₱25,000 (Monthly Income)</option>
                <option value="26,000-50,000">₱26,000 - ₱50,000 (Monthly Income)</option>
                <option value="51,000">₱51,000 Above (Monthly Income)</option>
            </select>
